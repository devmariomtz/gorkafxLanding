    ...
    <div className="bg-[#000b17] pt-4">
      ...
      <div className="flex flex-wrap gap-5 md:gap-16 justify-center p-6">
        <div className="md:w-[27vw] md:h-[25vw] w-full h-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex flex-col items-center justify-center text-center">
          <img src="src/assets/estrategia.png" alt="" className="w-[35%]" />
        ...
        <div className="md:w-[27vw] md:h-[25vw] w-full h-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex flex-col items-center justify-center text-center">
          <img
            src="src/assets/material-exclusivo.png"
            alt=""
            className="w-[35%]"
          />
          <div className="text-xl p-4">
        ...
        <div className="md:w-[27vw] md:h-[25vw] w-full h-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex flex-col items-center justify-center text-center">
          <img src="src/assets/mentoria.png" alt="" className="w-[35%]" />
          <div className="text-xl p-4">
        ...
        <div className="md:w-[27vw] md:h-[25vw] w-full h-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex flex-col items-center justify-center text-center">
          <img src="src/assets/comunidad.png" alt="" className="w-[35%]" />
          <div className="text-xl p-4">
        ...
        <div className="md:w-[27vw] md:h-[25vw] w-full h-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex flex-col items-center justify-center text-center">
          <img src="src/assets/online.png" alt="" className="w-[35%]" />
          <div className="text-xl p-4">
