...
const Form = () => {
  return (
    <React.Fragment>
      ...
      <div
        className="md:flex  w-full p-5 h-auto md:h-[75vh] justify-center items-center text-white bg-[#000b17]"
        id="contact"
      >
        <p className="md:text-4xl md:w-[50%] leading-normal text-2xl text-balance md:text-start text-center">
          Actualmente, las plazas están
          <span className="font-semibold m-0 p-0 "> agotadas.</span> Te
          invitamos a rellenar nuestro
          <span className="font-semibold m-0 p-0">
            {" "}
            formulario de preinscripción.{" "}
          </span>
          De esta manera, recibirás una notificación tan pronto como se abran
          nuevas plazas.
        </p>
        <Formulario />
      </div>
